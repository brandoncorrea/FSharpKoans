...
module ``about lists`` =
    ...
    let BuildingNewLists() =
        ...
        //                created?
        // You can create new lists from existing lists, but you cannot modify
        // an existing list.
    ...
    (* :: performs better because it just adds a value to the head of the
       linked list. With @ concatenation, a new list is likely being allocated
       and each value added to the new list. *)
