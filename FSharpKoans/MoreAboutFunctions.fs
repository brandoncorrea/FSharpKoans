...
module ``more about functions`` =
    ...
    let NonCurriedFunctions() =
        ...
        (* Functions with no arguments, (), accept the unit argument.
           Uncurried functions with one argument, (x), accept one argument.
           Uncurried functions with seemingly two arguments, (x, y), accept one tuple.
           Tuples may contain many values. *)
